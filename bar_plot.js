// !preview r2d3 data= data.frame(label = c("Ba5", "Co9", "Ba4", "Ja39", "Go17", "Go16"), y = c(144.00,  990.00, 42.00, 975.00, 405.00, 99.00 ), x = c("GPT", "GPT", "GPT","GPT","GPT","GPT"))
